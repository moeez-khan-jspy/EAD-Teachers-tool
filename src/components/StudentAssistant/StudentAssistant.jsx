...
import './StudentAssistant.css'; // This should be your unified CSS file
...
const StudentAssistant = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!selectedCurriculum || !selectedSubject || !selectedGrade) {
      setError('Please select curriculum, subject, and grade.');
      return;
    }
    ...
    try {
      ...
      if (response) {
        ...
        throw new Error("I couldn't find an answer. Please try rephrasing.");
      }
    } catch (err) {
        ...
        <form onSubmit={handleSubmit} className="generator-form">
          ...
          <div className="form-group">
            ...
            <textarea
              ...
              placeholder="Ask about anything you need help with..."
              required
              rows="4"
